...
@section('title', 'Edit Tentang Desa - Portal Parakan')

@section('page-header')
  <div class="d-flex justify-content-between align-items-center">
    <h4 class="fw-bold py-3 mb-4">
      <span class="text-muted fw-light">Portal Parakan / Tentang Desa /</span> Edit Informasi Desa
    </h4>
          ...
          <div class="card-body">
            <div class="row g-3">
              <div class="col-md-6">
                ...
                <input type="number" class="form-control counter-input @error('people_total') is-invalid @enderror" 
                       id="people_total" name="people_total" 
                       value="{{ old('people_total', $aboutVillage->people_total) }}" 
                       placeholder="0" min="0">
                @error('people_total')
              ...
              <div class="col-md-6">
                ...
                <input type="number" class="form-control counter-input @error('family_total') is-invalid @enderror" 
                       id="family_total" name="family_total" 
                       value="{{ old('family_total', $aboutVillage->family_total) }}" 
                       placeholder="0" min="0">
                @error('family_total')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              ...
              <div class="col-md-6">
                ...
                <input type="number" class="form-control counter-input @error('blok_total') is-invalid @enderror" 
                       id="blok_total" name="blok_total" 
                       value="{{ old('blok_total', $aboutVillage->blok_total) }}" 
                       placeholder="0" min="0">
                @error('blok_total')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              ...
              <div class="col-md-6">
                ...
                <input type="number" class="form-control counter-input @error('program_total') is-invalid @enderror" 
                       id="program_total" name="program_total" 
                       value="{{ old('program_total', $aboutVillage->program_total) }}" 
                       placeholder="0" min="0">
                @error('program_total')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <textarea class="form-control @error('description') is-invalid @enderror" 
                        id="description" name="description">{{ old('description', $aboutVillage->description) }}</textarea>
              @error('description')
                <div class="invalid-feedback">{{ $message }}</div>
              @enderror
          ...
          <div class="card-body">
            <div class="mb-3">
              ...
              <textarea class="form-control @error('location') is-invalid @enderror" 
                        id="location" name="location" rows="4" 
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control @error('no_telp') is-invalid @enderror" 
                     ...
                     value="{{ old('no_telp', $aboutVillage->no_telp) }}" 
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control @error('email') is-invalid @enderror" 
                     id="email" name="email" 
                     value="{{ old('email', $aboutVillage->email) }}" 
      ...
      if (draft) {
        try {
          ...
          if (diffMinutes < 30) {
            ...
            const confirmMessage = `Ditemukan draft yang tersimpan ${draftAge} menit yang lalu. Apakah Anda ingin memuat draft tersebut?`;
