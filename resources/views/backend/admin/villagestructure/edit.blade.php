...
@section('page-header')
    <div class="d-flex justify-content-between align-items-center">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Manajemen Struktur Pemerintahan /</span> Edit Pejabat
        </h4>
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="mb-3">
                                            @if ($structure->photo_url)
                                                <img id="photo-preview" src="{{ $structure->photo_url }}"
        ...
        function previewPhoto(input) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    preview.innerHTML =
                        `<img src="${e.target.result}" alt="Preview" class="rounded-circle img-fluid" style="width: 150px; height: 150px; object-fit: cover;">`;
                };
