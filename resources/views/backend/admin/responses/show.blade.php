...
@section('page-header')
    <div class="d-flex justify-content-between align-items-center">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Manajemen Pengaduan /</span> Detail Tanggapan
        </h4>
                    ...
                    @if (isset($allResponses) && $allResponses->count() > 0)
                        <div class="timeline-wrapper">
                            @foreach ($allResponses as $index => $resp)
                                <div
                                    class="response-timeline-item {{ $resp->id == $response->id ? 'current-response' : '' }}">
                                    <div
                                        class="response-timeline-marker 
                    @if ($resp->status == 'pending') bg-warning 
                    @elseif($resp->status == 'process') bg-info 
                    @elseif($resp->status == 'resolved') bg-success @endif">
                                        {{ $index + 1 }}
                                    </div>
                                    <div class="response-timeline-content">
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <div>
                                                ...
                                                <div class="d-flex gap-2 align-items-center">
                                                    ...
                                                    @endif
                                                    <small
                                                        class="text-muted">{{ $resp->created_at->format('d M Y, H:i') }}</small>
                                                </div>
                                            </div>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('complaint-response.show', $resp->id) }}">
                                                            <i class="bx bx-show me-2"></i>Lihat Detail
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('complaint-response.edit', $resp->id) }}">
                                        ...
                                        <div class="response-author mb-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <small
                                                    class="text-muted">{{ $resp->user->name ?? 'Administrator' }}</small>
                                            </div>
                                        </div>
