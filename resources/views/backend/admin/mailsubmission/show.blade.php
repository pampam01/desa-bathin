      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="d-grid gap-2">
            <!-- Generate PDF Button -->
            @if(!$mailSubmission->file)
              <form action="{{ route('mail-submissions.generate-pdf', $mailSubmission->id) }}" method="POST" class="d-inline">
                @csrf
                <button type="submit" class="btn btn-success w-100" onclick="return confirm('Yakin ingin membuat file PDF? Status akan otomatis diubah menjadi Selesai.')">
                  <i class="bx bx-file-blank me-2"></i>Buat File PDF
                </button>
              </form>
            @else
              <!-- Download PDF Button -->
              <a href="{{ route('mail-submissions.download-pdf', $mailSubmission->id) }}" class="btn btn-primary">
              ...
              <form action="{{ route('mail-submissions.generate-pdf', $mailSubmission->id) }}" method="POST" class="d-inline">
                @csrf
                <button type="submit" class="btn btn-outline-success w-100" onclick="return confirm('Yakin ingin membuat ulang file PDF?')">
