...
@section('title', 'Profile - Portal Parakan')
  ...
  <div class="row">
    ...
    <div class="col-xl-8 col-lg-7">
      ...
      <div class="card mb-4" id="profile-form">
        ...
        <div class="card-body">
          <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" id="updateProfileForm">
            @csrf
            @method('PUT')
  ...
  function previewAvatar(input) {
    if (input.files && input.files[0]) {
      ...
      reader.onload = function(e) {
        ...
        currentAvatar.innerHTML = `<img src="${e.target.result}" alt="Preview" class="rounded-circle" width="60" height="60" style="object-fit: cover;">`;
      }
