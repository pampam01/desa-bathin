...
@section('page-header')
    <div class="d-flex justify-content-between align-items-center">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Manajemen Berita /</span> Edit Berita
        </h4>
    ...
    <form action="{{ route('news.update', $news->id) }}" method="POST" enctype="multipart/form-data" id="newsForm">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card mb-4">
                    <div class="card-header">
                        <h5 class="mb-0"><i class="bx bx-edit me-2"></i>Informasi Berita</h5>
                    </div>
                    <div class="card-body">
                        <!-- Title -->
                        <div class="mb-3">
                            ...
                            @enderror
                            <div class="form-text">Judul akan muncul sebagai headline berita</div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug"
                                name="slug" value="{{ old('slug', $news->slug) }}" placeholder="otomatis-dari-judul">
                            @error('slug')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <!-- Content -->
                        <div class="mb-3">
                            <label for="content" class="form-label">Konten Berita <span
                                    class="text-danger">*</span></label>
                            <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" required>{{ old('content', $news->content) }}</textarea>
                            @error('content')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('tags') is-invalid @enderror" id="tags"
                                name="tags" value="{{ old('tags', $news->tags) }}" placeholder="Tag1, Tag2, Tag3">
                            @error('tags')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text">Pisahkan tag dengan koma (contoh: kesehatan, pendidikan, ekonomi)</div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status"
                                ...
                                <option value="published"
                                    {{ old('status', $news->status) == 'published' ? 'selected' : '' }}>Dipublikasikan
                                </option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="mb-3">
              ...
              <div class="form-text">Berita unggulan akan ditampilkan di slider utama</div>
            </div>
