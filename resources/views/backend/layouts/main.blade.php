{{-- 
    File ini telah dikonversi menjadi struktur partial.
    Silakan gunakan: @extends('backend.admin.layouts.app')
    
    File backup asli tersimpan di: main.blade.php.backup
    Dokumentasi lengkap ada di: README.md
--}}

@extends('backend.admin.layouts.app')

@section('title', 'Dashboard - Portal KUA bathin')
...
@section('content')
    ...
    <div class="alert alert-info">
        <h5><i class="bx bx-info-circle me-2"></i>Layout Telah Dikonversi</h5>
        <p class="mb-2">File layout utama telah dipisah menjadi beberapa partial untuk kemudahan maintenance:</p>
        <ul class="mb-3">
            <li><strong>Head:</strong> partials/head.blade.php</li>
            <li><strong>Sidebar:</strong> partials/sidebar.blade.php</li>
            <li><strong>Navbar:</strong> partials/navbar.blade.php</li>
            <li><strong>Footer:</strong> partials/footer.blade.php</li>
            <li><strong>Scripts:</strong> partials/scripts.blade.php</li>
        </ul>
        <p class="mb-2">Contoh penggunaan tersedia di file: <code>dashboard.blade.php</code></p>
        <p class="mb-0">Dokumentasi lengkap: <code>README.md</code></p>
    </div>
@endsection
<!-- Layout wrapper -->
