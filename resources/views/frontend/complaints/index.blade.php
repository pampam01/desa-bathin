        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <h1 class="display-4 fw-bold mb-3">Pengaduan Masyarakat</h1>
                    <p class="lead">Informasi terkini tentang kegiatan dan perkembangan KUA Bathin XXIV</p>
                </div>
                <div class="col-lg-4">
                    <!-- Search Form -->
                    <form method="GET" action="{{ route('frontend.complaints.index') }}" class="mt-4">
                        <div class="input-group">
                            <input type="text" class="form-control search-bar" name="search"
                                value="{{ request('search') }}" placeholder="Cari Pengaduan Masyarakat...">
        ...
        <div class="container">
            @if (request('search'))
                <div class="alert alert-info">
                    ...
                    <a href="{{ route('frontend.complaints.index') }}" class="btn btn-sm btn-outline-primary ms-2">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <article class="news-card">
                                ...
                                <div class="news-card-body">
                                    ...
                                    <a href="{{ route('frontend.complaints.show', $item->id) }}"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <h4 class="text-muted mb-3">
                        @if (request('search'))
                            Tidak ada Pengaduan Masyarakat yang ditemukan
                        @else
                            Belum ada Pengaduan Masyarakat tersedia
                        @endif
                    </h4>
                    <p class="text-muted">
                        @if (request('search'))
                            Coba gunakan kata kunci yang berbeda atau
                            <a href="{{ route('frontend.complaints.index') }}">lihat semua Pengaduan Masyarakat</a>
                        @else
                            Pengaduan Masyarakat akan segera tersedia. Silakan kembali lagi nanti.
                        @endif
                    </p>
                </div>
            @endif
