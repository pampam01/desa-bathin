...
@push('styles')
    <style>
        ...
        .back-to-list:hover {
            ...
            box-shadow: 0 10px 20px rgba(102, 234, 115, 0.4);
            color: white;
        }
    </style>
@endpush
...
@section('content')
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('frontend.complaints.index') }}">Pengaduan
                                    Masyarakat</a></li>
                            <li class="breadcrumb-item active">{{ Str::limit($complaints->title, 50) }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    <a href="{{ route('frontend.complaints.index') }}" class="btn btn-secondary rounded-4 mb-3">
                    ...
                    <article class="news-content">
                        <div class="news-header">
                            <div class="news-meta">
                                <span class="badge me-2">Pengaduan Masyarakat Desa</span>
                                <i class='bx bx-time-five me-1'></i>
                                {{ $complaints->created_at->format('d F Y, H:i') }} WIB
                                <span class="mx-2">•</span>
                                <i class='bx bx-user me-1'></i>
                                {{ $complaints->user->name ?? 'Admin' }}
                            </div>
                            <h1 class="news-title">{{ $complaints->title }}</h1>
                        </div>

                        @if ($complaints->image)
                            <img src="{{ asset('storage/' . $complaints->image) }}" alt="{{ $complaints->title }}"
                        ...
                        <div class="social-share">
                            <h6 class="mb-3">
                                ...
                                Bagikan Pengaduan Masyarakat Ini
                            </h6>
                            <div class="d-flex flex-wrap">
                                ...
                                <a href="https://twitter.com/intent/tweet?url={{ urlencode(request()->fullUrl()) }}&text={{ urlencode($complaints->title) }}"
                                    target="_blank" class="btn btn-info btn-share">
                                    <i class='bx bxl-twitter me-1'></i>
                                    Twitter
                                </a>
                                <a href="https://wa.me/?text={{ urlencode($complaints->title . ' - ' . request()->fullUrl()) }}"
                        ...
                        <div class="related-news">
                            ...
                            @foreach ($relatedComplaints as $related)
                                <div class="related-news-card mb-3">
                                    ...
                                    <div class="card-body">
                                        <h6>
                                            <a href="{{ route('frontend.complaints.show', $related->id) }}"
