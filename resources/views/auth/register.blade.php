...
@section('title', 'Registrasi - Portal Parakan')

@section('heading', 'Daftar Akun Portal Parakan 🏛️')

@section('subheading', 'Bergabunglah dengan sistem informasi desa untuk mendapatkan layanan terbaik!')
